...
## 问题现象
在使用MindSpore 1.6.0版本进行模型训练时，构建了一个包含10维张量的ReduceSum单算子网络，运行时报错：RuntimeError: In op, the num of dimensions of input/output[x] should be in the range of [0, 8], but actually is [10]。
